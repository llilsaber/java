...
<%
	...
	ArrayList<DramaVO> list = db.list();
%>
<!DOCTYPE html>
<html>
<head>
...
for (int i = 0; i < list.size(); i++) {
   DramaVO bag2 = list.get(i);
%>
	<a href="page2.jsp?title=<%=bag2.getTitle() %>" title="<%= bag2.getTitle() %>"><img src="pic/<%= bag2.getTitle() %>_pic.jpg" width=300 height="300"></a>
