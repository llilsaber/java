...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<h3>공지사항 검색</h3>
		<hr color="red">
		<form action="noticeSelect2">
		<table>
			<tr><td>번호: <input type="text" name="nnumber" readonly></td></tr>  
			<tr><td>아이디: <input type="text" name="userid"></td></tr> 
			<tr><td>제목: <input type="text" name="ntitle"></td></tr> 
			<tr><td>날짜: <input type="text" name="ndate" readonly></td></tr> 
			<tr><td>내용: <input type="text" name="ndetails" readonly></td></tr> 
		</table>
		<br>
		<input type="submit" value="공지사항 검색">	
		</form>
		</div>
	</body>
</html>
