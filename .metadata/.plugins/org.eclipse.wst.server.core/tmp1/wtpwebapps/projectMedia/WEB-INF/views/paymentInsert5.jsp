...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<h3>결제 상품 등록 완료</h3>
		<hr color="red">
			아이디 ${paymentVO.userid}<br>
			이름 ${paymentVO.pname}<br>
			연락처 ${paymentVO.ptel}<br>
			상품 ${paymentVO.pproduct}<br>
			코드 ${paymentVO.pcode}<br>
			수량 ${paymentVO.pquantity}<br>
			금액 ${paymentVO.ppayment}<br>
		<br>
		<a href="payment_all5.jsp">결제 상품</a>
		</div>
	</body>
</html>