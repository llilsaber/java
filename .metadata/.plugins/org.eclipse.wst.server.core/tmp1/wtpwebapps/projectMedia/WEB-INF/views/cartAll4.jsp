...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<div id="content">
		<hr>
		<h3 style="font-weight: bold; background-color: white; width: 200px; text-align: center; border-radius: 5px; padding: 5px;">장바구니</h3>
		...
		<br>
			<div style="text-align: center">
				<a class="btnStyle" href="cart_insert4.jsp">등록</a>
				<a class="btnStyle" href="cart_delete4.jsp">삭제</a>
			</div>
		</div>
	</body>
</html>