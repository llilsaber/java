...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<div id="content">
			...
			<hr color="white">
			<!-- 
				이부분을 메인페이지가 아닌 UserLogout으로 한 이유는 탈퇴를 했음에도
				세션이 계속잡고 있기 때문에, 세션을 해제하기 위해서 UserLogout.jsp로 넘어가도록 했습니다.
				UserLogout.jsp는 메인 페이지로 redirect가 되었기 때문에 바로 세션을 해제해서 메인페이지로 갑니다.
			-->
			<a href="UserLogout.jsp">
