...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<table>
			...
			<tr><td>코드: <input type="text" name="ccode"></td></tr>
			<tr><td>수량: <input type="text" name="cquantity"></td></tr>
			<tr><td>금액: <input type="text" name="cpayment"></td></tr>
		</table>
		<hr>
		<input type="submit" value="장바구니 상품 등록">
		</form>
		</div>
	</body>
</html>