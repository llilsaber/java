...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<h3>결제상품 삭제</h3>
		<hr color="red">
		<form action="paymentDelete5">
		<table>
			<tr><td>번호: <input type="text" name="pnumber" readonly></td></tr> 
			<tr><td>아이디: <input type="text" name="userid"></td></tr>
			<tr><td>이름: <input type="text" name="pname" readonly></td></tr>
			<tr><td>연락처: <input type="text" name="ptel" readonly></td></tr> 
			<tr><td>날짜: <input type="text" name="pdate" readonly></td></tr> 						
			<tr><td>상품: <input type="text" name="pproduct"></td></tr>
			<tr><td>코드: <input type="text" name="pcode" readonly></td></tr> 
			<tr><td>수량: <input type="text" name="pquantity" readonly></td></tr>
			<tr><td>금액: <input type="text" name="ppayment" readonly></td></tr>			
		</table>
		<br>
	   	<input type="submit" value="결제 상품 삭제">
		</form>
		</div>
	</body>
</html>