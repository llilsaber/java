		...
		<div id="content">
			<div id = "inputForm">
				...
				<form action="create">
					...
					<input value="${vo2.userid}" type="text" id="userid" name="userid"><br>
					...
					<input placeholder="이메일" type="text" id="uemail" name="uemail"><br>
					
					<label for="ubirth">생년월일</label><br>
					<input placeholder="생년월일" type="text" id="ubirth" name="ubirth"><br><br>
