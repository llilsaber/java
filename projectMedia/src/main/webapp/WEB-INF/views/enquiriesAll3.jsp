...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<div id="content">
		<hr>
		<h3 style="font-weight: bold; background-color: white; width: 200px; text-align: center; border-radius: 5px; padding: 5px;">문의사항</h3>
		...
		<br>
			<div style="text-align: center">
				<a class="btnStyle" href="enquiries_insert3.jsp">등록</a>
				<a class="btnStyle" href="enquiries_select3.jsp">검색</a>
				<a class="btnStyle" href="enquiries_update3.jsp">수정</a>
				<a class="btnStyle" href="enquiries_delete3.jsp">삭제</a>	
			</div>
		</div>
	</body>
</html>