...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<div id="content">
		<hr>
		<h3 style="font-weight: bold; background-color: white; width: 200px; text-align: center; border-radius: 5px; padding: 5px;">공지사항</h3>
		...
		<br>
			<div style="text-align: center">
				<a class="btnStyle" href="notice_insert2.jsp">등록</a>
				<a class="btnStyle" href="notice_select2.jsp">검색</a>
				<a class="btnStyle" href="notice_update2.jsp">수정</a>
				<a class="btnStyle" href="notice_delete2.jsp">삭제</a>
			</div>
		</div>
	</body>
</html>