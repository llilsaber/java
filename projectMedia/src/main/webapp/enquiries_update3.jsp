...
<html style="margin: 0px">
	...
	<body id="body">
		...
		<h3>문의사항 수정</h3>
		<hr color="red">
	<form action="enquiriesUpdate3">
	<table>	
		<tr><td>번호: <input type="text" name="enumber" readonly></td></tr>  
		<tr><td>아이디: <input type="text" name="userid"></td></tr> 
		<tr><td>제목: <input type="text" name="etitle"></td></tr> 
		<tr><td>날짜: <input type="text" name="edate" readonly></td></tr> 
		<tr><td>내용: <input type="text" name="edetails" style="width:500px; height: 300px;"></td></tr>
	</table>
	<hr color="red">		
   <input type="submit" value="문의사항 수정">
</form>
		</div>
	</body>
</html>