...
<hr>
<input id="car1" type="button" value='meen.png' style='background:yellow; font-size:20px;'>
<input id="car2" type="button" value='suri.png'  style='background:pink; font-size:20px;'>
<input id="car3" type="button" value='meen + suri'  style='background:pink; font-size:20px;'>
<hr color="red" size="5">
<div></div>
</body>
</html>
